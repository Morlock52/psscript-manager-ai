...
# Test script to upload a new PowerShell script to the backend API
SCRIPT_PATH="./test-script-new.ps1"
...
echo "Uploading new test script to $API_URL..."
curl -v -F "title=Network Info PowerShell Script" \
     -F "description=This script retrieves network information from a Windows system" \
