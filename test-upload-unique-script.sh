...
# Test script to upload a unique PowerShell script to the backend API
SCRIPT_PATH="./test-script-unique.ps1"
...
echo "Uploading unique test script to $API_URL..."
curl -v -F "title=Disk Info PowerShell Script" \
     -F "description=This script retrieves detailed disk information from a Windows system" \
